...
export const PosActionsMenu = ({ pos }: PosActionsMenuProps) => {
  ...
  return (
    <>
      ...
      <EditPos pos={pos} isOpen={editOpen} setIsOpen={setEditOpen} />
      <DeletePos id={pos.id} isOpen={deleteOpen} setIsOpen={setDeleteOpen} />
    </>
  )
}
